...
def main(cfg):
    ...
    for i in range(5):
        ...
        print(target_2d['kp_2d'].shape)
        print(target_2d['flow'].shape)
        print(target_2d['feature'].shape)
    ...
    for i in range(5):
        ...
        print(target_3d['kp_2d'].shape)
        print(target_3d['flow'].shape)
        print(target_3d['feature'].shape)
    #'''
    ...
    loss = VIBELoss(
        ...
        optical_flow_loss_weight=cfg.LOSS.OPTICAL_FLOW_LOSS_W
    )
    ...
    for i, param in enumerate(params):
        print(f"Parameter {i}: {param.size()}", flush=True)
