...
def hmr(smpl_mean_params=SMPL_MEAN_PARAMS, pretrained=True, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-models on ImageNet
    """
...
def get_part_pretrained_hmr5():
    ...
    print(weights.shape)
    new_weights = torch.cat((weights, torch.zeros(size=(64, 2, 7, 7), device=weights.device)), dim=1)
